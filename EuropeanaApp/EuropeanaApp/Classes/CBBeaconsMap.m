...
@property IXBeacon *touchedBeacon;
@property IXBeacon *nearestBeacon;
...
- (void)calculateAndSetEstimatedPosition:(CGPoint)lastEstimated {
    ...
    for (IXBeacon *beacon in _beacons) {
...
- (float)pixelDistanceFor:(IXBeacon *)beacon {
